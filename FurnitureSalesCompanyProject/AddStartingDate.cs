...
namespace FurnitureSalesCompanyProject
{
    public class AddStartingDate
    {
        public void Add()
        {
            ...
            Furniture furniture1 = new Furniture() {FurnitureName = furnitureName1, Model = "СК-1", Cost = 15000.20, Specifications ="Сделана из поликарбаната. Ширина: 1.5м, Высота: 0.6м"};
            Furniture furniture2 = new Furniture() { FurnitureName = furnitureName1, Model = "СК-2", Cost = 12000, Specifications = "Сделана из дерева. Ширина: 5м, Высота: 2м" };
            Furniture furniture3 = new Furniture() { FurnitureName = furnitureName2, Model = "Ш-1", Cost = 30000, Specifications = "Ширина: 1м, Высота: 3м" };
            Furniture furniture4 = new Furniture() { FurnitureName = furnitureName2, Model = "Ш-2", Cost = 35000, Specifications = "Сделана из поликарбаната." };
            Furniture furniture5 = new Furniture() { FurnitureName = furnitureName3, Model = "Т-0", Cost = 4000, Specifications = "Дверки: раздвижные. Ширина: 1м, Высота: 3м" };
